...
<template>
  <div>
    <div class="w-full flex px-4 py-2 justify-between shadow-md">
      ...
      <div class="hidden sm:flex sm:items-center sm:gap-x-4 sm:flex-grow">
        ...
        <div v-if="isAuthed" class="flex gap-x-4">
          <p class="font-semibold cursor-pointer">User Profile</p>
